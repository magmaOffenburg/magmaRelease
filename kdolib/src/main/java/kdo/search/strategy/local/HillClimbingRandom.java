 ...
 */
public class HillClimbingRandom extends HillClimbing
{
	/** the number of cycles that did not produce an improvement */
	private long cyclesWithoutImprovement;

	/** the maximum number of cycles that did not produce an improvement */
	private final long maxCyclesWithoutImprovement;
	 ...
	 */
	public HillClimbingRandom(long maxCyclesWithoutImprovement, long maxRuntime)
	{
		super(maxRuntime);
	...
	{
		return "HillClimbing Random Operator. maxCyclesWithoutImprovement: " + maxCyclesWithoutImprovement;
	}
	...
	{
		if (cyclesWithoutImprovement > maxCyclesWithoutImprovement) {
			// too many cycles without improvement, so normal hillclimbing
