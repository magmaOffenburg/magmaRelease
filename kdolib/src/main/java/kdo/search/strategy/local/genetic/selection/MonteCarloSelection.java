...
public class MonteCarloSelection extends RouletteWheelSelectionBase
{
	 ...
	 */
	public MonteCarloSelection(boolean ascending, IRandomSource rand)
	{
		this("MonteCarloSelection", rand, ascending);
	}
	 ...
	 * @param ascending true if high values represent good utilities
	 */
	public MonteCarloSelection(String name, IRandomSource rand, boolean ascending)
	{
